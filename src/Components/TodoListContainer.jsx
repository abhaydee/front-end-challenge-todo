  ...
  return (
    <>
      {todolist.map((item,index) => {
        return (
          <div
            className={`inputlist-container inputlist-container${theme===true?"__light":"__dark"}`}
            key={index}
          >
            <div className="inputlist-container__child">
              <div className="inputlist-container__child__checkmark" onClick={handleComplete}>
                {completed===true &&
                  <img
                  src={IconCheck}
                  alt="check-icon"
              ...
              <p className={`inputlist-container__text inputlist-container__text${completed===true?"__completed":""}`} onClick={()=>handleUpdate(index,item.input)}>{item.input}</p>
              <img
                src={IconCross}
                alt="delete-icon"
